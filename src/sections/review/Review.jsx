            ...
            <Container>
                ...
                <div className="review__wrapper">
                    ...
                    <div className="review__users">
                        <img src="/assets/users-1.png" alt="User-1" />
                        <img src="/assets/users-2.png" alt="User-2" />
                        <img src="/assets/users-3.png" alt="User-3" />
                        <div className="review__user__selected">
                            <img src="/assets/users-4.png" alt="User-4" />
                            <div>
                                <h3>Scarlett Thomas</h3>
                                <p>Singapore</p>
                            </div>
                        </div>
                        <img src="/assets/users-5.png" alt="User-5" />
                        <img src="/assets/users-6.png" alt="User-6" />
                    </div>
                </div>
            </Container>
        </div>
